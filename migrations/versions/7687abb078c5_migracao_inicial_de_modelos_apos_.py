"""Migracao inicial de modelos apos consolidacao de Status e correcao geral

Revision ID: 7687abb078c5
Revises: 
Create Date: 2025-09-16 12:36:54.850310
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['group_id'], ['group.id'], name='fk_event_permission_group_id'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_event_permission_user_id'),
    sa.PrimaryKeyConstraint('id'),
